...
public class PlanetAdapter extends ArrayAdapter<Planet> {
    ...
    public View getView(int position, View convertView,
        ...
        TextView tvDistance=(TextView)view.findViewById(R.id.textViewPlanetDistanceNum);
        TextView tvDiameter=(TextView)view.findViewById(R.id.textViewPlanetDiameterNum);
        tvName.setText(planet.getName());
        tvDistance.setText(planet.getDistanceFromSun().toString());
